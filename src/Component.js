 ...
 */
Component.getComponentClassName = function () {
 ...
 */
Component.prototype.findComponent = function (filterFn) {
 ...
 */
Component.prototype.findComponents = function (filterFn) {
    if (!utils.isFunction(filterFn)) {
        return [];
    }
 ...
 * @return {*}       返回取到的值
 */
Component.prototype.getData = function (names, dft) {
    if (!this.tree || !this.tree.rootScope) {
        throw new Error('component is not ready');
    }
 ...
 * @return {Class}             子类
 */
Component.extends = function (props, staticProps) {
    var baseCls = this;
